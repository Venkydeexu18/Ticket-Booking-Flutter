          ...
          children: [
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: Container(
                  padding: EdgeInsets.fromLTRB(20, 45, 20, 8),
                  child: Stack(
                    clipBehavior: Clip.none,
                    children: [
                      SizedBox(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        border: Border.all(color: Color(0xFFFF53BC)),
                                        borderRadius: BorderRadius.circular(10),
                                        gradient: LinearGradient(
                                          begin: Alignment(-0.771, -0.875),
                                          end: Alignment(0.443, 1),
                                          colors: <Color>[Color(0xFFB1116C), Color(0xFF411371)],
                                          stops: <double>[0, 1],
                                        ),
                                      ),
                                      child: Container(
                                        padding: EdgeInsets.fromLTRB(13, 6.5, 13.8, 6.5),
                                        child: Text(
                                          '18:00',
                                          style: GoogleFonts.getFont(
                                            'Poppins',
